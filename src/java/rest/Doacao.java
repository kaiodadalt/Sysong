...
@NamedQueries({
    ...
    , @NamedQuery(name = "Doacao.findByTipo", query = "SELECT d FROM Doacao d WHERE d.tipo = :tipo")
    , @NamedQuery(name = "Doacao.findByTag", query = "SELECT d FROM Doacao d WHERE d.tag = :tag")})
public class Doacao implements Serializable {
    ...
    public Doacao(Integer id, String tipo, String tag) {
        this.id = id;
        this.tipo = tipo;
        this.tag = tag;
    }
